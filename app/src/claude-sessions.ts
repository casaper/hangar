...
/**
 * The resumable Claude Code sessions of one clone -- what `hangar resume` picks from.
 *
...
const readTranscript = (file: string): ClaudeTranscript | undefined => {
  ...
  // conflict `hangar sync` resolves leaves one behind. They are not sessions anybody
