 ...
 * (`hangar status 1`), so that is how it is shown. Anything naming a DIRECTORY keeps the
 ...
 * fails CLOSED (returns false) when there is no terminal at all -- an unattended `hangar sync`
