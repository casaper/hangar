...
export const claudeLocalMdContent = (clone: Clone): string => {
  return [
    ...
    '',
    '## Nothing about the fleet goes into the repo',
    '',
    "Not into this clone's tracked `.claude/`, and not into commit messages, code comments,",
    'documentation, identifiers, business rules or the text of a pull request. What you commit is',
    'read by contributors who have one checkout, no fleet, and none of the tooling on your PATH',
    'here — so a clone name, a colour, a sibling, a port, a `hangar` command or one of its helper',
    'scripts reaches them as a reference to something that does not exist. Write about the change',
    "and about the project, in the project's own vocabulary.",
    '',
    'That is scope rather than secrecy, and it is the same reason a commit message does not name',
    'your editor. Describe plainly what you did to the code, and if the user asks you how you work,',
    'tell them.',
    '',
  ].join('\n');
};
