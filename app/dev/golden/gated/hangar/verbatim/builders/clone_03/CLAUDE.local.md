# This clone: clone_03 (green)

You are working in **`clone_03`**, one of the sibling clones under `~/code/dvb_gn/`.
...
`~/.claude/themes/dvb_gn-clone-03-green.json`, both selected in this clone's untracked
...
|                        |                                     |
| ---------------------- | ----------------------------------- |
| Root                   | `/Users/someone/code/dvb_gn/clone_03` |
| Colour                 | green                               |
| Angular dev server     | 4400                                |
| Storybook              | 6206                                |
| Playwright HTML report | 9523                                |
