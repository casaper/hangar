# This clone: clone_04 (red)

You are working in **`clone_04`**, one of the sibling clones under `~/code/dvb_gn/`.
Announce yourself as **red** when the user needs to tell your session apart from
the others.
...
`~/.claude/themes/dvb_gn-clone-04-red.json`, both selected in this clone's untracked
...
|                   |                                     |
| ----------------- | ----------------------------------- |
| Root              | `/Users/someone/code/dvb_gn/clone_04` |
| Colour            | red                                 |
| `ng serve`        | 4500                                |
| Storybook         | 6306                                |
...
But `hangar sync 4` — this clone — starts with a
