# This clone: clone_01 (cyan)

You are working in **`clone_01`**, one of the sibling clones under `~/code/dvb_gn/`.
...
`~/.claude/themes/dvb_gn-clone-01-cyan.json`, both selected in this clone's untracked
...
|                        |                                     |
| ---------------------- | ----------------------------------- |
| Root                   | `/Users/someone/code/dvb_gn/clone_01` |
| Colour                 | cyan                                |
