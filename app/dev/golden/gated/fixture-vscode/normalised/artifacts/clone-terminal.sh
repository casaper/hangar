...
_hangar_vsfix_tinted() {
    local r rest g b
    r=${1%%;*}; rest=${1#*;}; g=${rest%%;*}; b=${rest#*;}
    printf '#%02x%02x%02x' "$((r * _hangar_vsfix_tint / 100))" "$((g * _hangar_vsfix_tint / 100))" "$((b * _hangar_vsfix_tint / 100))"
}
...
_hangar_vsfix_chrome_set() {
    ...
    case "${_hangar_vsfix_fam}" in
        ...
        konsole|osc11)
            ...
            printf '\033]11;%s\a' "$(_hangar_vsfix_tinted "$1")"
            ;;
    esac
}
