# This clone: checkout_0001 (cyan)

You are working in **`checkout_0001`**, one of the sibling clones under `%HANGAR%/`.
Announce yourself as **cyan** when the user needs to tell your session apart from
the others.
...
`~/.claude/themes/vsfix-clone-0001-cyan.json`, both selected in this clone's untracked
...
|                   |                                                                                         |
| ----------------- | --------------------------------------------------------------------------------------- |
| Root              | `%HANGAR%/checkout_0001` |
| Colour            | cyan                                                                                    |
| Next dev server   | 4200                                                                                    |
| Storybook         | 6006                                                                                    |
...
But `hangar sync 1` — this clone — starts with a
