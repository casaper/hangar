# This clone: checkout_0002 (yellow)

You are working in **`checkout_0002`**, one of the sibling clones under `%HANGAR%/`.
...
`~/.claude/themes/vsfix-clone-0002-yellow.json`, both selected in this clone's untracked
...
|                   |                                                                                         |
| ----------------- | --------------------------------------------------------------------------------------- |
| Root              | `%HANGAR%/checkout_0002` |
| Colour            | yellow                                                                                  |
| Next dev server   | 4250                                                                                    |
| Storybook         | 6056                                                                                    |
| Playwright report | 9373                                                                                    |
...
editing `tmp/UI-1234/ticket.md` in place writes every clone's copy of it, and nothing
