# This clone: wt-001 (cyan)

You are working in **`wt-001`**, one of the sibling clones under `%HANGAR%/`.
...
`~/.claude/themes/wt-clone-001-cyan.json`, both selected in this clone's untracked
