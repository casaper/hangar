...
#
# hangar_wt_colour <clone>  ->  "<r;g;b> <xterm-256 index> <name> <ink> <bar text>"
#
# Read it with two lines, in any POSIX shell:
#     set -- $(hangar_wt_colour "$clone") ; rgb=$1 x256=$2 name=$3 ink=$4 bar=$5
#
...
hangar_wt_colour() {
    case "$1" in
        wt-001) printf '0;204;255 45 cyan #000000 #00ccff'    ;;   # #00ccff
        wt-002) printf '255;204;0 220 yellow #000000 #ffcc00' ;;   # #ffcc00
        wt-003) printf '0;204;0 40 green #000000 #00cc00'     ;;   # #00cc00
        *)      return 1 ;;
    esac
}
